...
import com.example.faridabadtaxirider.Model.Rate;
...
public class RateActivity extends AppCompatActivity {
    ...
    private void submitRateDetails(final String driverId) {
        final AlertDialog alertDialog=new SpotsDialog.Builder().setContext(RateActivity.this).build();
        alertDialog.show();

        final Rate rate=new Rate();
        rate.setRates(String.valueOf(ratingBar));
        ...
        rateDetailRef.child(driverId)
                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        //If upload succeed on Firebase , just calculate average and update to driver inforation
                        rateDetailRef.child(driverId)
